...
To make it easier for me to get a better picture of what happend in all runs, I have taken the values below by merging all runs and producing the means of each variable I was investigating. When looking to investigate the learner engagement of the course I set out to look at the following questions for this dataset:

-	Percentages of the leaving reasons for which learners left.
-	Percentages of the leaving steps at which learners left.

In both the leaving steps and reasons I have only used the datasets from runs 4 to 7 because of the differences in the previous runs and the difficulty in merging sets with different steps.
