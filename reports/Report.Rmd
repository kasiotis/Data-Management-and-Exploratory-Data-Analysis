...
This particular data set is actually ready for analysis as it is. It does not require any cleaning or preprocessing in order to answer the data mining goals set out earlier. It already has pre-calculated values for the percentages of everything I want to investigate.
